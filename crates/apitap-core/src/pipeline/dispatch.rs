...
use crate::sink::iceberg::{IcebergConn, IcebergSink};
...
routes! {
    ...
    "postgres" -> "iceberg"    : PgFrom => IceTo, TO_ICEBERG, pg_overlap = false;
    ...
    "github+api" -> "iceberg"   : GhApiFrom => IceTo, GH_API, pg_overlap = false;
    ...
    "mysql"    -> "iceberg"    : MyFrom => IceTo, TO_ICEBERG, pg_overlap = false;
    ...
    "gsheets"  -> "iceberg"    : GsFrom => IceTo, GSHEETS, pg_overlap = false;
